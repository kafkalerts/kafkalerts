...
const LoginBox = ({ setPassword, setUsername, handleSend }) => {
  return (
    <div id='login-container' className='container'>
      <TextField id='username' type='text' label='Username: ' onChange={setUsername} isRequired />
      <TextField id='password' type='password' label='Password: ' onChange={setPassword} isRequired />
      <div id='button-box'>
